...
public class TileManager {
    ...
    public void getTileImage(){
        try{
            ...
            tile[1] = new Tile();
            tile[1].image = ImageIO.read(new File("res/tiles/stone.png"));
            ...
            tile[3] = new Tile();
            tile[3].image = ImageIO.read(new File("res/tiles/dirt.png"));

            tile[4] = new Tile();
            tile[4].image = ImageIO.read(new File("res/tiles/sand.png"));

            tile[5] = new Tile();
            tile[5].image = ImageIO.read(new File("res/tiles/tree.png"));
